...
# ///////////////////////////////////////////////////////////////////////////
# $Id: Electrodes.py 7935 2024-03-14 16:23:17Z jhill $
...
class ChannelSet(numpy.matrix):
	...
	def rasterplot(self, img, x=None, y=None, interactive=False, drawnow=True, **imgArgs):
		...
		plt.figure( h.axes.figure ); plt.axes( h.axes )
		...
		def select( channelIndex, paramValue ):
			...
			if len( h.channels ) > 1:
				plt.figure( h.topoAxes.figure ); plt.axes( h.topoAxes )
			...
			plt.figure( h.paramAxes.figure ); plt.axes( h.paramAxes )
...
def trodeplot(channels=(), act='connected',
	...
	else: plt.figure(ax.figure); plt.axes(ax)
	fig = ax.get_figure()
	if not hold: ax.cla()
