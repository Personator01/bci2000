...
# ///////////////////////////////////////////////////////////////////////////
# $Id: Numerics.py 7900 2024-03-07 04:37:31Z jhill $
...
def match_events( base_indices, candidate_indices, min_offset=None, max_offset=0, fs=1.0 ):
	"""
	...
	*intention* to deliver a particular stimulus, which occurs (and is
	...
	for base_index in base_indices:
		...
		if close_enough:
			closest = min( close_enough, key=lambda candidate_index: ( abs( candidate_index - base_index ), candidate_index ) )
