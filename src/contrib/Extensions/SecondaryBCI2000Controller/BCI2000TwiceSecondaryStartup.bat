...
#######################################################################################
## $Id: BCI2000TwiceSecondaryStartup.bat 8056 2024-04-22 19:54:35Z mellinger $
...
Start executable SignalGenerator localhost:5000 --local --AllowMultipleInstances --SecondaryBCI2000=0
