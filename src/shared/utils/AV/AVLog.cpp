//////////////////////////////////////////////////////////////////////
// $Id: AVLog.cpp 7978 2024-03-28 09:55:38Z mellinger $
...
#if 1
    // This message was classified as error and appeared frequently during develpment using
    // an RDP-forwarded webcam.
    // It should not appear with a locally connected webcam, though.
    if (message.find("frame dropped!") != std::string::npos)
        return;
#endif
