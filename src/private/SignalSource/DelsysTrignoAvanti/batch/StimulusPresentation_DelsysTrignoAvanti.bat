...
#######################################################################################
## $Id: StimulusPresentation_DelsysTrignoAvanti.bat 8056 2024-04-22 19:54:35Z mellinger $
...
Start executable DelsysTrignoAvanti --local
...
Load parameterfile "../parms/fragments/amplifiers/DelsysTrignoAvanti.prm"
