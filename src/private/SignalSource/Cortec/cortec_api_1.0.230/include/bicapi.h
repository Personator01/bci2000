...
extern "C" {
    ...
    */
    ...
    /**
    * Function to query a string containing an unique identifier for the software version of this library.
    ...
    *
    * @return -1 if an error occurred (e.g., length of versionString > len or versionString == nullptr), 
    *         otherwise the length of versionString (excluding zero terminator).
    */
