...
public:
    ...
    /**
    * @return Empty stimulation command with repetition count 1. Caller is responsible for deletion of returned pointer.
    */
    ...
    */
    ...
    /**
    * Creates a stimulation function that consists of the following five atoms:
    ...
    * Dead Zone1: The pause at the end of a stimulation function.
    *  
    ...
    * @param[in] duration     Duration in microseconds of the stimulation.
    *
    ...
    * duration.
    *
    * @param[in] duration Duration in microseconds of the pause.
    * @return Initialized stimulation atom. Caller is responsible for deletion of returned pointer.
    */
