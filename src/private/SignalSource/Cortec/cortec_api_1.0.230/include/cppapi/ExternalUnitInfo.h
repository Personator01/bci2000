...
namespace cortec { namespace implantapi {
    ...
    public:
        /**
          * @param[in] deviceType Type of the external unit.
          * @param[in] hardwareRevision Version of the external unit's hardware.
          * @param[in] deviceId Unique identifier of the external unit.
          * @param[in] firmwareVersion Version of the external unit's firmware.
          */
        CExternalUnitInfo(const std::string& deviceType, const std::string& hardwareRevision,
            const std::string& deviceId, const std::string& firmwareVersion);
        ...
        */
        ...
        /// @return Type of the external unit.
        virtual std::string getDeviceType() const;

        /// @return Hardware revision of the external unit.
