...
/**
* @brief Interface for receiving data from an IImplant object, such as created by the IImplantFactory's create methods.
* The received data can be implant state changes, implant health state changes or error messages from an IImplant object.
*/
class IImplantListener
{
    ...
    *        so on... The pointer's ownership is passed to the listener and needs to be deleted after processing.
    */
    ...
    *
    * @param[in] voltageV Voltage of the implant in volts.
    */
    ...
    */
    ...
    /**
    * Callback triggered when errors inside the driver library occur during runtime.
    * Examples:
    ...
    */
    ...
    /**
    * Callback triggered during an active stimulation, each time a stimulation function or pause has been executed.
    *
    * @param[in] numFinishedFunctions The number of so far executed stimulation functions/pauses of the current command.
    */
    virtual void onStimulationFunctionFinished(const uint64_t numFinishedFunctions) = 0;

    /**
    * Callback triggered during an active stimulation, each time a stimulation function is executed.
    * Stimulation ids are related to the position of the stimulation function in the command.
    * The first stimulation function in the command has the ID: 1.
    * 
    * @param[in] id The id of the last stimulation function executed. 
    */
    virtual void onLastStimulationFunctionId(const uint16_t id) = 0;
