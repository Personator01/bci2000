...
#######################################################################################
## $Id: StimulusPresentation_Natus.bat 8056 2024-04-22 19:54:35Z mellinger $
...
Start executable NatusSignalSource --local
#Start executable SignalGenerator --local --TestLoggerFrequency=0Hz --TestLoggerEmitDebug=0
Start executable DummySignalprocessing --local
Start executable StimulusPresentation --local
Wait for Connected
Load parameterfile "../batch/testNatus.prm"