...
decltype(&__6628320c_gt_common1) gt_common1 = 0;
decltype(&__662b320c_gt_common2) gt_common2 = 0;
decltype(&__662a320c_gt_common3) gt_common3 = 0;
...
decltype(&__24381f4a_gt_sec_5V_supply) gt_sec_5V_supply = 0;
decltype(&__70193f37_gt_selftest_error) gt_selftest_error = 0;
...
decltype(&__2f06706f_isOpenDevicePhysically) isOpenDevicePhysically = 0;
decltype(&__25526954_is_FES_serial) is_FES_serial = 0;
decltype(&__1e310062_is_factory_config_valid) is_factory_config_valid = 0;
...
decltype(&__7e622a32_rcv_common1) rcv_common1 = 0;
decltype(&__7e622932_rcv_common2) rcv_common2 = 0;
decltype(&__7e622832_rcv_common3) rcv_common3 = 0;
...
decltype(&__38203a1f_rcv_sec_5V_supply) rcv_sec_5V_supply = 0;
...
decltype(&__7f6f3832_snd_common1) snd_common1 = 0;
decltype(&__7f6f3b32_snd_common2) snd_common2 = 0;
decltype(&__7f6f3a32_snd_common3) snd_common3 = 0;
...
decltype(&__7228320c_st_common1) st_common1 = 0;
decltype(&__722b320c_st_common2) st_common2 = 0;
decltype(&__722a320c_st_common3) st_common3 = 0;
...
const Dylib::Import functionImports_[] =
{
  ...
  { "gt_common1", (void**)&gt_common1, Dylib::Import::cMangled },
  { "gt_common2", (void**)&gt_common2, Dylib::Import::cMangled },
  { "gt_common3", (void**)&gt_common3, Dylib::Import::cMangled },
  ...
  { "gt_sec_5V_supply", (void**)&gt_sec_5V_supply, Dylib::Import::cMangled },
  { "gt_selftest_error", (void**)&gt_selftest_error, Dylib::Import::cMangled },
  ...
  { "isOpenDevicePhysically", (void**)&isOpenDevicePhysically, Dylib::Import::cMangled },
  { "is_FES_serial", (void**)&is_FES_serial, Dylib::Import::cMangled },
  { "is_factory_config_valid", (void**)&is_factory_config_valid, Dylib::Import::cMangled },
  ...
  { "rcv_common1", (void**)&rcv_common1, Dylib::Import::cMangled },
  { "rcv_common2", (void**)&rcv_common2, Dylib::Import::cMangled },
  { "rcv_common3", (void**)&rcv_common3, Dylib::Import::cMangled },
  ...
  { "rcv_sec_5V_supply", (void**)&rcv_sec_5V_supply, Dylib::Import::cMangled },
  ...
  { "snd_common1", (void**)&snd_common1, Dylib::Import::cMangled },
  { "snd_common2", (void**)&snd_common2, Dylib::Import::cMangled },
  { "snd_common3", (void**)&snd_common3, Dylib::Import::cMangled },
  ...
  { "st_common1", (void**)&st_common1, Dylib::Import::cMangled },
  { "st_common2", (void**)&st_common2, Dylib::Import::cMangled },
  { "st_common3", (void**)&st_common3, Dylib::Import::cMangled },
