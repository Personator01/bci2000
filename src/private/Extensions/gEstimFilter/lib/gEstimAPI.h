...
#define API_VERSION "1.18.07.6179"    //!< This is the API version. It is the same as in the AssemblyInfo.

#define MAX_CALLBACK_FIELDSCHANGED 11 //!< Only this many callback functions can be registered with \ref register_with_polling()

#define G_ESTIM_FW {"V1.4", "V1.3", "V1.23", NULL} ///< FW Versions (newest first). FW_version_ must fit up to the length of this string.
#define G_ESTIM_HW {"V1.4", "V1.3", NULL} ///< HW Version (newest first). It must fit to the Hardware version up to the length of this string.
#define G_ESTIM_FW_HW_COUNT 6 /// count of combinations of FW and HW version that are recognized
#define G_ESTIM_FW_HW_IDX { {0,0}, {0,1}, {1,0}, {1,1}, {2,0}, {2,1} } ///< only these combinations of G_ESTIM_FW and G_ESTIM_HW are allowed
...
/** Is this device open? Check physically (FTDI)

*/
DLL_PUBLIC bool isOpenDevicePhysically(
        PGDevice d //!< device handle
        );
...
/** Returns selftest error.

*/
DLL_PUBLIC GError gt_selftest_error(
    PGDevice d   //!< the device handle
    );
...
[1]. &loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Alternating setting see ::GAlternate <BR><STRONG>CUBE_TES</STRONG>: - not used

*/
DLL_PUBLIC uint16_t gt_alternate_default(
    PGDevice d  //!< device handle
    );
...
*/
DLL_PUBLIC uint16_t gt_alternate_max(
    PGDevice d  //!< device handle
    );
...
*/
DLL_PUBLIC uint16_t gt_alternate_min(
    PGDevice d  //!< device handle
    );
...
[10uA]. &loz;<BR><STRONG>@EstimPRO</STRONG>: Stimulation amplitude phase 1  <BR><STRONG>@EstimFES</STRONG>: Stimulation amplitude phase 1 [40&mu;A]<BR><STRONG>@CUBE_FES</STRONG>: Stimulation amplitude phase 1 [mA]. This must be minus phase_current2_. <BR><STRONG>@CUBE_TES</STRONG>: Stimulation amplitude  [1&mu;A]
...
[10uA]. &loz;<BR><STRONG>@EstimPRO</STRONG>: Stimulation amplitude phase 1  <BR><STRONG>@EstimFES</STRONG>: Stimulation amplitude phase 2 [40&mu;A]<BR><STRONG>@CUBE_FES</STRONG>: Stimulation amplitude phase 2 [mA]. This must be minus phase_current1_. <BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
[10us]. &loz;<BR><STRONG>@EstimPRO</STRONG>: Stimulation phase 1 duration <BR><STRONG>@EstimFES/@CUBE_FES</STRONG>:  Stimulation phase 1 duration 
...
[10us]. &loz;<BR><STRONG>@EstimPRO</STRONG>: Stimulation phase 2 duration <BR><STRONG>@EstimFES/@CUBE_FES</STRONG>:  Stimulation phase 2 duration 
...
[1ms]. &loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Stimulation fade in time <BR><STRONG>@CUBE_TES</STRONG>: Rising ramp duration [100ms]
...
[1ms]. &loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Stimulation fade out time  <BR><STRONG>@CUBE_TES</STRONG>: Falling ramp duration [100ms]
...
[1]. &loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>:  Fade in/out using phase or amplitude or both see ::GFade <BR><STRONG>@CUBE_TES</STRONG>:  sham single/dual or off see ::GSham

*/
DLL_PUBLIC uint16_t gt_fade_type_default(
    PGDevice d  //!< device handle
    );
...
*/
DLL_PUBLIC uint16_t gt_fade_type_max(
    PGDevice d  //!< device handle
    );
...
*/
DLL_PUBLIC uint16_t gt_fade_type_min(
    PGDevice d  //!< device handle
    );
...
[10us]. &loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Duration between phases .<BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
[0.1Hz]. &loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Stimulation pulse rate .<BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
[1]. &loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Number of stimulation pulses <BR><STRONG>@CUBE_TES</STRONG>: Train duration [100ms]
...
[1ms]. &loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Pre-stimulation time DO1 <BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
[1ms]. &loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Post-stimulation time DO1 <BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
[1ms]. &loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Pre-stimulation time DO2 <BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
[1ms]. &loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Post-stimulation time DO2 <BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
[1]. &loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: DO1 functionality setting see ::GDO <BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED

*/
DLL_PUBLIC uint16_t gt_do1_function_default(
    PGDevice d  //!< device handle
    );
...
*/
DLL_PUBLIC uint16_t gt_do1_function_max(
    PGDevice d  //!< device handle
    );
...
*/
DLL_PUBLIC uint16_t gt_do1_function_min(
    PGDevice d  //!< device handle
    );
...
[1]. &loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: DO2 functionality setting see ::GDO <BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED

*/
DLL_PUBLIC uint16_t gt_do2_function_default(
    PGDevice d  //!< device handle
    );
...
*/
DLL_PUBLIC uint16_t gt_do2_function_max(
    PGDevice d  //!< device handle
    );
...
*/
DLL_PUBLIC uint16_t gt_do2_function_min(
    PGDevice d  //!< device handle
    );
...
[1]. &loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Actual state of high voltage LED (1 = high-voltage)<BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
Device serial number e.g. "ES-2014.12.14" or "CE-2020.01.01A" - only writeable if PROG jumper set
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Device identifier can be flashed by API <BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG> Device identifier fix "g.CUBE_SC06_FES"/"g.CUBE_SC06_TES"
...
/** Retrieves from the g.Estim device 
 ...
 Device firmware version - first 10 byte FW_version_uC1, second 10 byte FW_version_uC2 e.g. "1.0.0-001 1.2.0-000 " Versioning: Major.Minor.Patch-optional
...
Device hardware version - only writeable if PROG jumper set
...
Device current source 1 calibration coefficients [1/1000,1&mu;A]
...
Estim: Device current source 2 calibration coefficients [1/1000,1&mu;A] - only writeable if PROG jumper set <BR> RW &loz D - CUBE used for internal resistance [1R, 1R] - only writeable if PROG jumper set
...
Device current measurement calibration coefficients [1/1000,10&mu;A] - only writeable if PROG jumper set
...
Device voltage measurement calibration coefficients [1/1000,0.1V] - only writeable if PROG jumper set
...
Device resistance measurement calibration coefficients [1/1000,1/1000] - only writeable if PROG jumper set
...
Voltage above which GEVENT_HIGHVOLTAGE will happen [0.1V]
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Alternating setting see ::GAlternate <BR><STRONG>CUBE_TES</STRONG>: - not used
...
*/
DLL_PUBLIC uint16_t gt_alternate(
        PGDevice d//!< device handle
        );
...
DLL_PUBLIC bool st_alternate(
        PGDevice d,//!< device handle
        uint16_t alternate//!< value to set. 
        );
...
&loz;<BR><STRONG>@EstimPRO</STRONG>: Stimulation amplitude phase 1  [10&mu;A]<BR><STRONG>@EstimFES</STRONG>: Stimulation amplitude phase 1 [40&mu;A]<BR><STRONG>@CUBE_FES</STRONG>: Stimulation amplitude phase 1 [mA]. This must be minus phase_current2_. <BR><STRONG>@CUBE_TES</STRONG>: Stimulation amplitude  [1&mu;A]
...
&loz;<BR><STRONG>@EstimPRO</STRONG>: Stimulation amplitude phase 1  [10&mu;A]<BR><STRONG>@EstimFES</STRONG>: Stimulation amplitude phase 2 [40&mu;A]<BR><STRONG>@CUBE_FES</STRONG>: Stimulation amplitude phase 2 [mA]. This must be minus phase_current1_. <BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO</STRONG>: Stimulation phase 1 duration [10&mu;s]<BR><STRONG>@EstimFES/@CUBE_FES</STRONG>:  Stimulation phase 1 duration [10&mu;s] This must be equal to phase_duration2_.<BR><STRONG>@CUBE_TES</STRONG>: Sham rising ramp duration [100ms]
...
&loz;<BR><STRONG>@EstimPRO</STRONG>: Stimulation phase 2 duration [10&mu;s]<BR><STRONG>@EstimFES/@CUBE_FES</STRONG>:  Stimulation phase 2 duration [10&mu;s] This must be equal to phase_duration1_.<BR><STRONG>@CUBE_TES</STRONG>: Sham falling ramp duration [100ms]
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Stimulation fade in time [ms]<BR><STRONG>@CUBE_TES</STRONG>: Rising ramp duration [100ms]
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Stimulation fade out time  [ms]<BR><STRONG>@CUBE_TES</STRONG>: Falling ramp duration [100ms]
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>:  Fade in/out using phase or amplitude or both see ::GFade <BR><STRONG>@CUBE_TES</STRONG>:  sham single/dual or off see ::GSham
...
*/
DLL_PUBLIC uint16_t gt_fade_type(
        PGDevice d//!< device handle
        );
...
DLL_PUBLIC bool st_fade_type(
        PGDevice d,//!< device handle
        uint16_t fade_type//!< value to set. 
        );
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Duration between phases [10mu;s].<BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Stimulation pulse rate [0.1 Hz].<BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Number of stimulation pulses [1]<BR><STRONG>@CUBE_TES</STRONG>: Train duration [100ms]
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Pre-stimulation time DO1 [ms]<BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Post-stimulation time DO1 [ms]<BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Pre-stimulation time DO2 [ms]<BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Post-stimulation time DO2 [ms]<BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: DO1 functionality setting see ::GDO <BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
*/
DLL_PUBLIC uint16_t gt_do1_function(
        PGDevice d//!< device handle
        );
...
DLL_PUBLIC bool st_do1_function(
        PGDevice d,//!< device handle
        uint16_t do1_function//!< value to set. 
        );
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: DO2 functionality setting see ::GDO <BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
*/
DLL_PUBLIC uint16_t gt_do2_function(
        PGDevice d//!< device handle
        );
...
DLL_PUBLIC bool st_do2_function(
        PGDevice d,//!< device handle
        uint16_t do2_function//!< value to set. 
        );
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Actual state of high voltage LED (1 = high-voltage)<BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Device battery 1 charge with values {0, 100-200}<BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: Channel compliance voltage [0.1V]
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Device battery 2 charge with values {0, 100-200}<BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: Device internal temperature [°C]
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Device inputs state, bit meaning by GMask<BR><STRONG>@CUBE_FES/@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Stores the progress of the fade in or fade out (<0 fade in, >0 fade out, =0 no fade) <BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_TES</STRONG>: Sum of stimulation current samples during phase 1 [&mu;A]<BR><STRONG>@CUBE_FES</STRONG>: Sum of stimulation current samples during phase 1 [10&mu;A]
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>: Sum of stimulation current samples during phase 2 [&mu;A]<BR><STRONG>@CUBE_FES</STRONG>: Sum of stimulation current samples during phase 1 [10&mu;A]<BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Average stimulation voltage samples during phase 2 [0.1V]<BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Counts the samples used for current2_sum_ or voltage2_sum_<BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
*/
DLL_PUBLIC bool st_common1(
        PGDevice d,//!< device handle
        int16_t common1//!< value to set. 
        );
...
*/
DLL_PUBLIC bool st_common2(
        PGDevice d,//!< device handle
        int16_t common2//!< value to set. 
        );
...
*/
DLL_PUBLIC bool st_common3(
        PGDevice d,//!< device handle
        int16_t common3//!< value to set. 
        );
...
Measured 5V secondary supply voltage [mV] 


@snippet gEstimAPI.h rcv_snd
*/
DLL_PUBLIC bool rcv_sec_5V_supply(
        PGDevice d//!< device handle
        );
...
*/
DLL_PUBLIC int16_t gt_sec_5V_supply(
        PGDevice d//!< device handle
        );

/** Retrieves from the g.Estim device 

&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Number of stimulated pulses <BR><STRONG>@CUBE_TES</STRONG>: Stimulation time since last read [100ms]
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES</STRONG>:Current measurement array of last pulse [&mu;A]<BR><STRONG>@CUBE_FES</STRONG>: Current measurement array of last pulse [10&mu;A]<BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
&loz;<BR><STRONG>@EstimPRO/@EstimFES/@CUBE_FES</STRONG>: Voltage measurement array of last pulse [0.1 V]<BR><STRONG>@CUBE_TES</STRONG>: NOT USED
...
/** Check if factory settings file is valid (signature).

Returns false, if the factory settings file was manipulated.

*/
DLL_PUBLIC bool is_factory_config_valid();
