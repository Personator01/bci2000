...
private:
  ...
  static ControllerContainer CreateControllers(int startIndex, int endIndex, bool ignoreMissing, const ParamRef& formats, const ParamRef& urls, const ParamRef& audiourls);
