////////////////////////////////////////////////////////////////////////////////
// $Id: NeurofeedbackTaskFilter.cpp 7464 2023-06-30 15:04:08Z mellinger $
...
NeurofeedbackTaskFilter::Initialize( const SignalProperties& Input, const SignalProperties& Output )
{
  ...
  // threads, store any information you need in private member variables.
	...
	*/ 
	...
	m_text_baseline_string			= std::string(Parameter("TextBaseline"));
	m_text_pain_rating_string		= std::string(Parameter("TextPainRating"));
	m_text_pain_exception_string	= std::string(Parameter("TextPainException"));
	m_text_relax_string				= std::string(Parameter("TextRelax"));
	m_text_training_string			= std::string(Parameter("TextTraining"));
	m_text_anti_string				= std::string(Parameter("TextAnti"));
	m_text_stim_string				= std::string(Parameter("TextStim"));
	m_text_reward_string			= std::string(Parameter("TextReward"));
