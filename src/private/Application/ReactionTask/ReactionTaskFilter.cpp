////////////////////////////////////////////////////////////////////////////////
// $Id: ReactionTaskFilter.cpp 7464 2023-06-30 15:04:08Z mellinger $
...
ReactionTaskFilter::Initialize( const SignalProperties& Input, const SignalProperties& Output )
{
	...
	m_text_feedback_pos				= std::string(Parameter("TextFeedbackPos"));
	m_text_feedback_neg_false_start = std::string(Parameter("TextFeedbackNegFalseStart"));
	m_text_feedback_neg_too_fast	= std::string(Parameter("TextFeedbackNegTooFast"));
	m_text_feedback_neg_too_slow	= std::string(Parameter("TextFeedbackNegTooSlow"));
	m_text_feedback_pre_cue			= std::string(Parameter("TextFeedbackPreCue"));
	m_text_feedback_pre_stim		= std::string(Parameter("TextFeedbackPreStim"));
	m_text_feedback_task_finished   = std::string(Parameter("TextFeedbackTaskFinished"));
