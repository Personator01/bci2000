////////////////////////////////////////////////////////////////////////////////
// $Id: FeedbackScene2D.cpp 7464 2023-06-30 15:04:08Z mellinger $
...
void FeedbackScene2D::OnInitialize()
{
    ...
    {
        EllipticShape*pTarget = new EllipticShape(mDisplay);
        GUI::Point targetDiag = {Targets(i, r), Targets(i, r)};
