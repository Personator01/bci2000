////////////////////////////////////////////////////////////////////////////////
// $Id: StimulusTask.cpp 7464 2023-06-30 15:04:08Z mellinger $
...
StimulusTask::StimulusTask()
    : mPhase(none), mBlocksInPhase(0), mBlocksSinceStimulus(0), mISIDuration(0), mStartTime(0),
...
void StimulusTask::Preflight(const SignalProperties &Input, SignalProperties &Output) const
{
    ...
    const char *timeParams[] = {
        "StartTime",   "PostRunDuration", "PreSequenceDuration", "PostSequenceDuration",
    ...
    float StartTime = Parameter("StartTime").InSampleBlocks();
    if (StartTime < 1)
        bcierr << "StartTime must be >= 1 data block";
...
void StimulusTask::Process(const GenericSignal &Input, GenericSignal &Output)
{
    ...
    {
      bool active = mPhotoDiodePatch.expression.Evaluate(&Output);
