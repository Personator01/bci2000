////////////////////////////////////////////////////////////////////////////////
// $Id: FeedbackScene3D.cpp 7464 2023-06-30 15:04:08Z mellinger $
...
void FeedbackScene3D::OnInitialize()
{
    ...
    for (int i = 0; i < Parameter("NumberTargets"); ++i)
    {
        ...
        sphere* pTarget = new sphere(*mpScene);
        pTarget->setRadius(Targets(i, r));
        Vector3D posTarget = { Targets(i, x), Targets(i, y), Targets(i, z) };
        pTarget->setOrigin(posTarget);

        pTarget->setBrightness(1);
        pTarget->setAngVelocity(0, 0, 0);
