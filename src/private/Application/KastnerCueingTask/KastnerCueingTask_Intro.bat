...
#######################################################################################
## $Id: KastnerCueingTask_Intro.bat 8056 2024-04-22 19:54:35Z mellinger $
...
Start executable KastnerCueingTask --local
Wait for Connected
Load parameterfile "../parms.ECoG/KastnerCueingTask/KastnerCueingTask.prm"

Set Parameter PresentationMode 1	# 1 = Intro; 3 = Testing
Set Parameter ListVsRandom 1		# 1 = pre-defined list; 2 = random list