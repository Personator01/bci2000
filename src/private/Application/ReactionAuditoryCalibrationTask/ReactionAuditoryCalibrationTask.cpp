////////////////////////////////////////////////////////////////////////////////
// $Id: ReactionAuditoryCalibrationTask.cpp 7464 2023-06-30 15:04:08Z mellinger $
// Authors:
...
ReactionAuditoryCalibrationTask::Initialize( const SignalProperties& Input, const SignalProperties& Output )
{
  ...
  m_max_num_trials                = Parameter("MaxItrNum");
    ...
    m_text_feedback_pre_cue			= std::string(Parameter("TextFeedbackPreCue")); // Text which can be presented if we had different types of stimulus!!!
    ...
    m_text_feedback_false_start     = std::string(Parameter("TextFeedbackFalseStart"));
...
//  Parameters->ByName("PerceptionThreshold").Serialize(f);
 ...
 Parameter("PestStartLevel") = m_auditory_intensity;
  ...
  ff << Parameters->ByPath("PestStartLevel");
