////////////////////////////////////////////////////////////////////////////////
// $Id: Scale.cpp 7464 2023-06-30 15:04:08Z mellinger $
...
Scale::CalculateFontSize( int width, int height, QPainter* painter )
{
    ...
    while( fontwidth < width && fontheight < height )
    {
      ...
      fontwidth = painter->fontMetrics().boundingRect( longest ).width();
...
HorizontalScale::OnPaint( const GUI::DrawContext& inDC )
{
  ...
  int fontwidth = p->fontMetrics().boundingRect( longest ).width();
