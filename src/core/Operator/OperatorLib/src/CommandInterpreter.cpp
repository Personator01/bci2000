////////////////////////////////////////////////////////////////////////////////
// $Id: CommandInterpreter.cpp 7848 2024-02-21 18:19:06Z mellinger $
...
CommandInterpreter::LogStream CommandInterpreter::Log()
{
    if (::atoi(mLocalVariables[LogLevelName()].c_str()))
