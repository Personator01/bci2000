////////////////////////////////////////////////////////////////////////////////
// $Id: SignalGeneratorADC.cpp 8032 2024-04-13 12:50:38Z mellinger $
...
SignalGeneratorADC::SignalGeneratorADC()
    : mRandomGenerator(this), mNoiseAmplitude(0), mDCOffset(0), mSineChannelX(0), mSineChannelY(0), mSineChannelZ(0),
      mModulateAmplitude(true), mVariateTiming(false), mAmplitudeX(1), mAmplitudeY(1), mAmplitudeZ(1), mHaveMouseLog(false),
      mDesktopWidth(0), mDesktopHeight(0)
{
}
