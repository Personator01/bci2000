###########################################################################
## $Id: AddTargetMacro.cmake 8049 2024-04-18 19:55:03Z mellinger $
    ...
    if( NOT outputDir )
      ...
      if(APPLE)
        ...
        if(USE_MACOS_APPLICATION_BUNDLES AND kind_ STREQUAL QTAPP AND MACDEPLOYQT)
            ...
            foreach(plugindir_ iconengines imageformats printsupport)
                list(APPEND build_macos_bundle_
                     COMMAND test -d 
"${outputDir}/${name_}.app/Contents/PlugIns/${plugindir_}" && rm -r 
"${outputDir}/${name_}.app/Contents/PlugIns/${plugindir_}" || 
true
                )
            endforeach()
            foreach(companion_ ${companions})
            ...
            # On ARM Macs, this is a requirement.
            list(APPEND build_macos_bundle_
